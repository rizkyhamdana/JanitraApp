package com.rizkyhamdana.janitraapp.ui.login
...
import com.rizkyhamdana.janitraapp.databinding.ActivityLoginBinding
        ...
        registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result: ActivityResult ->
            ...
            when (resultCode) {
                Activity.RESULT_OK -> {
                    ...
                    Toast.makeText(this, getString(R.string.cancel_login), Toast.LENGTH_SHORT).show()
                }
            }
        }
